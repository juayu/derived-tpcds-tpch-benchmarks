...
if len(sys.argv) != 4:
    print(
        "Invalid number of arguments. Usage: ./getclustercredentials.py cluster_identifier db_user db_name"
    )
    sys.exit(1)
...
# The psql wrapper expects a space delimited 'username password' to stdout
print(ret_val)
