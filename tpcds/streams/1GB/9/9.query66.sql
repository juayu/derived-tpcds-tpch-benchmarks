-- start query 66 in stream 9 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'HARMSTORF' || ',' || 'DHL' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 19827 and 19827+28800 
 	and sm_carrier in ('HARMSTORF','DHL')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
