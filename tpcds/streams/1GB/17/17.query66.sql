-- start query 66 in stream 17 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'GREAT EASTERN' || ',' || 'DIAMOND' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 52938 and 52938+28800 
 	and sm_carrier in ('GREAT EASTERN','DIAMOND')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
