     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 63 and 63+10
          or ss_coupon_amt between 13314 and 13314+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 130 and 130+10
          or ss_coupon_amt between 15727 and 15727+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 17354 and 17354+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 40 and 40+10
          or ss_coupon_amt between 16250 and 16250+1000
