-- start query 66 in stream 11 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'PRIVATECARRIER' || ',' || 'ORIENTAL' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 49145 and 49145+28800 
 	and sm_carrier in ('PRIVATECARRIER','ORIENTAL')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
