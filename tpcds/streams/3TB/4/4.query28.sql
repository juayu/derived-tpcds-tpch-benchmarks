...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 44 and 44+10 
             or ss_coupon_amt between 3964 and 3964+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 76 and 76+10
          or ss_coupon_amt between 15518 and 15518+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 80 and 80+10
          or ss_coupon_amt between 14609 and 14609+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 116 and 116+10
          or ss_coupon_amt between 13348 and 13348+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 163 and 163+10
          or ss_coupon_amt between 1055 and 1055+1000
