     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 113 and 113+10
          or ss_coupon_amt between 17409 and 17409+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 165 and 165+10
          or ss_coupon_amt between 14215 and 14215+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 55 and 55+10
          or ss_coupon_amt between 2747 and 2747+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 168 and 168+10
          or ss_coupon_amt between 677 and 677+1000
