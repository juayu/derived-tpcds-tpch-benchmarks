...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 182 and 182+10 
             or ss_coupon_amt between 7646 and 7646+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 158 and 158+10
          or ss_coupon_amt between 10397 and 10397+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 98 and 98+10
          or ss_coupon_amt between 15875 and 15875+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 162 and 162+10
          or ss_coupon_amt between 7144 and 7144+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 70 and 70+10
          or ss_coupon_amt between 10126 and 10126+1000
