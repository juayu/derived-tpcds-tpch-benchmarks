-- start query 66 in stream 14 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'ORIENTAL' || ',' || 'GREAT EASTERN' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 55512 and 55512+28800 
 	and sm_carrier in ('ORIENTAL','GREAT EASTERN')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
