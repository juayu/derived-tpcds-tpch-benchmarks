...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 130 and 130+10 
             or ss_coupon_amt between 13384 and 13384+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 75 and 75+10
          or ss_coupon_amt between 17956 and 17956+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 137 and 137+10
          or ss_coupon_amt between 3949 and 3949+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 57 and 57+10
          or ss_coupon_amt between 690 and 690+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 155 and 155+10
          or ss_coupon_amt between 16948 and 16948+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 171 and 171+10
          or ss_coupon_amt between 14840 and 14840+1000
