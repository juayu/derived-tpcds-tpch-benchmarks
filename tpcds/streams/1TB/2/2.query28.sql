...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 30 and 30+10 
             or ss_coupon_amt between 5396 and 5396+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 180 and 180+10
          or ss_coupon_amt between 1092 and 1092+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 184 and 184+10
          or ss_coupon_amt between 9671 and 9671+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 167 and 167+10
          or ss_coupon_amt between 11216 and 11216+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 26 and 26+10
          or ss_coupon_amt between 9163 and 9163+1000
