     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 46 and 46+10
          or ss_coupon_amt between 17683 and 17683+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 23 and 23+10
          or ss_coupon_amt between 11583 and 11583+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 126 and 126+10
          or ss_coupon_amt between 5583 and 5583+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 40 and 40+10
          or ss_coupon_amt between 274 and 274+1000
