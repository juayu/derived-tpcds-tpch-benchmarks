-- start query 66 in stream 10 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 16143 and 16143+28800 
 	and sm_carrier in ('MSC','RUPEKSA')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
