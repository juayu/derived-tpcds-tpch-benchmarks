...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 46 and 46+10 
             or ss_coupon_amt between 1011 and 1011+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 185 and 185+10
          or ss_coupon_amt between 12316 and 12316+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 184 and 184+10
          or ss_coupon_amt between 12045 and 12045+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 7 and 7+10
          or ss_coupon_amt between 14460 and 14460+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 86 and 86+10
          or ss_coupon_amt between 7879 and 7879+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 30 and 30+10
          or ss_coupon_amt between 7550 and 7550+1000
