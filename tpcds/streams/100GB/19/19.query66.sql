-- start query 66 in stream 19 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'USPS' || ',' || 'GREAT EASTERN' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 25738 and 25738+28800 
 	and sm_carrier in ('USPS','GREAT EASTERN')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
