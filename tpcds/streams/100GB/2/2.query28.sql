...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 124 and 124+10 
             or ss_coupon_amt between 4051 and 4051+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 179 and 179+10
          or ss_coupon_amt between 2684 and 2684+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 113 and 113+10
          or ss_coupon_amt between 5452 and 5452+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 58 and 58+10
          or ss_coupon_amt between 14297 and 14297+1000
