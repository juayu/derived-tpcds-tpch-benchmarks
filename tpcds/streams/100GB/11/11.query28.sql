...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 170 and 170+10 
             or ss_coupon_amt between 3450 and 3450+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 147 and 147+10
          or ss_coupon_amt between 13096 and 13096+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 76 and 76+10
          or ss_coupon_amt between 12340 and 12340+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 33 and 33+10
          or ss_coupon_amt between 13651 and 13651+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 86 and 86+10
          or ss_coupon_amt between 9220 and 9220+1000
