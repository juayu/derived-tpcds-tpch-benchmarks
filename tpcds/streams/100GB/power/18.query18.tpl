...
with /* query_templates/query18.tpl.0 !CF:IR-815dab58-a393-11e9-a528-06872b3fecc8.power_run01.power-query.power-0000.i0018.1.0:CF! */ results as
 (select i_item_id,
        ca_country,
        ca_state,
        ca_county,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,4,5,9,2,8) and
       d_year = 1999 and
       ca_state in ('NE','MD','WI','IN','TX','AL','TN')
 )
