-- start query 66 in stream 13 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'LATVIAN' || ',' || 'RUPEKSA' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 39270 and 39270+28800 
 	and sm_carrier in ('LATVIAN','RUPEKSA')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
