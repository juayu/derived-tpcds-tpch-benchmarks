     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 78 and 78+10
          or ss_coupon_amt between 5054 and 5054+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 77 and 77+10
          or ss_coupon_amt between 5115 and 5115+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 137 and 137+10
          or ss_coupon_amt between 8843 and 8843+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 159 and 159+10
          or ss_coupon_amt between 17332 and 17332+1000
