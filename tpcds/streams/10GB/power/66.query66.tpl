...
select /* query_templates/query66.tpl.0 !CF:IR-815dab58-a393-11e9-a528-06872b3fecc8.power_run01.power-query.power-0000.i0066.1.0:CF! */   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 	,w_county
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 52523 and 52523+28800 
 	and sm_carrier in ('GERMA','USPS')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
