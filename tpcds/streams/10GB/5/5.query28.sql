...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 95 and 95+10 
             or ss_coupon_amt between 11525 and 11525+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 128 and 128+10
          or ss_coupon_amt between 1464 and 1464+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 22 and 22+10
          or ss_coupon_amt between 5191 and 5191+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 11 and 11+10
          or ss_coupon_amt between 8890 and 8890+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 92 and 92+10
          or ss_coupon_amt between 3509 and 3509+1000
